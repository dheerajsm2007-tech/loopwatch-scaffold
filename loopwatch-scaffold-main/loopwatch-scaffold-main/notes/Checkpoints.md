...
- [ ] **Hour 16** — full demo (`demo/run_demo.py`) rehearsed twice. All 3 beats now wired (`demo_guard_off()` had a TODO, now uses `halting_enabled=False` + `max_steps`) — script is runnable, just not yet actually rehearsed live.
